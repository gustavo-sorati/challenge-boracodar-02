      ...
      <Head>
        ...
        <main className="flex flex-col items-center justify-center w-full h-screen bg-[#D9CDF7] p-2">
          <section className='flex-1 flex flex-col items-center justify-center md:flex-row'>             
            <div className='relative md:w-[861px]'>
              <button type='button' className="absolute top-2 right-6 z-10" onClick={handleUpdate3dView}>
                ...
                <Image src={viewIn360 ? animatedSofa : staticSofa}  priority quality={100} style={{ width: '500px', objectFit: 'cover'}} alt="sofá"/>
            </div>
            ...
            <div className='w-full flex flex-col gap-3 px-4'>
              ...
              <button className='mt-2 border-[1px] border-text rounded-full bg-transparent uppercase text-xs font-lato font-normal py-2 px-4 w-[150px]'
              >
                Adicionar a cesta
              </button>
            </div>
